...
def createInstance(app,group):
    ...
    if param is not None:
        ...
        param.setNthControlPoint(0, 0, 0, 0, 1, 1)
        param.setNthControlPoint(0, 1, 1, 1, 1, 1)
        param.setCurveColor(1, 0.7115, 0.1645, 0.1645)
        param.setNthControlPoint(1, 0, 0, 0, 1, 1)
        param.setNthControlPoint(1, 1, 1, 1, 1, 1)
        param.setCurveColor(2, 0, 0.547, 0)
        param.setNthControlPoint(2, 0, 0, 0, 1, 1)
        param.setNthControlPoint(2, 1, 1, 1, 1, 1)
        param.setCurveColor(3, 0.2885, 0.2885, 0.8355)
        param.setNthControlPoint(3, 0, 0, 0, 1, 1)
        param.setNthControlPoint(3, 1, 1, 1, 1, 1)
        param.setCurveColor(4, 0.399, 0.399, 0.399)
        param.setNthControlPoint(4, 0, 0, 0, 1, 1)
        param.setNthControlPoint(4, 1, 1, 1, 1, 1)
        del param
